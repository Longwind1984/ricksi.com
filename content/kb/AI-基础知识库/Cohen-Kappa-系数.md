...
- 上游基础：*混淆矩阵*、*准确率（Accuracy）*——见 [c14 - 模型评估体系与 Goodhart 陷阱](/kb/AI-基础知识库/c14-模型评估体系与-Goodhart-陷阱/) 中的评估指标讨论
- 近亲指标：*MCC*（Matthews 相关系数）、*F1 Score*
- 评估方法学：[c14 - 模型评估体系与 Goodhart 陷阱](/kb/AI-基础知识库/c14-模型评估体系与-Goodhart-陷阱/)——单一指标必然被博弈，多指标交叉验证才是工程实践

## 衍生对话存档

源对话：20260513-科恩卡帕系数与混淆矩阵的对应关系（2026-05-13，关于 Kappa 与混淆矩阵指标对应关系的解释）。
