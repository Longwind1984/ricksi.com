...
[Transformer](/kb/AI-基础知识库/Attention/) 是当前几乎所有大模型的基座架构。理解其核心机制是理解后续所有章节的前置条件。

## 3.1 Self-Attention 的物理直觉

每个 token 生成三个向量：Query (Q)、Key (K)、Value (V)。Q 是"我在找什么"，K 是"我能提供什么"，V 是"我的实际内容"。

Attention(Q, K, V) = [softmax](/kb/AI-基础知识库/Softmax/)(QK^T / √d_k) V
...
相关概念卡：[Attention 机制](/kb/AI-基础知识库/Attention/)、[KV Cache](/kb/AI-基础知识库/KV-Cache/)
模块二延伸：[m208 §2.5.4 模型服务层](/kb/AI-工程化与落地架构/m208-AI-基础设施与中间件选型/) — vLLM/SGLang 如何利用注意力机制优化实现高吞吐推理
上一章：[c02 Tokenization](/kb/AI-基础知识库/c02-Tokenization-与词表工程/)
下一章：[c04 模型训练 Pipeline](/kb/AI-基础知识库/c04-模型训练全阶段-Pipeline/)
