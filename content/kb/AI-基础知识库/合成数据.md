...
**合成数据 = 用模型（或程序）生成训练数据，喂给其它模型或自身迭代**。它是穿越 [数据墙](/kb/AI-基础知识库/c15-数据墙与后训练霸权/) 的核心手段，也是 2024 起前沿模型能力暴涨的隐形引擎。
...
| 3. 多 Agent 对抗 | 多 [Agent](/kb/AI-基础知识库/Agent/) 辩论 / 攻防 / 生成对抗 | Constitutional AI（critique + revise）、Debate 训练 |
...
3. **评估泄漏**：合成数据无意中包含 benchmark 题目 → 评估虚高（[c14](/kb/AI-基础知识库/c14-模型评估体系与-Goodhart-陷阱/)）
...
- [c04 数据策略](/kb/AI-基础知识库/c04-模型训练全阶段-Pipeline/)
- [c15 数据墙与合成数据](/kb/AI-基础知识库/c15-数据墙与后训练霸权/)
- [c14 评估独立性](/kb/AI-基础知识库/c14-模型评估体系与-Goodhart-陷阱/)

## 关联概念

[预训练](/kb/AI-基础知识库/预训练/)·[SFT](/kb/AI-基础知识库/SFT/)·[RLHF](/kb/AI-基础知识库/RLHF/)·[Constitutional AI](/kb/AI-基础知识库/Constitutional-AI/)·数据墙·[DeepSeek](/kb/AI-公司与产品/DeepSeek/)·蒸馏·[强化学习](/kb/AI-基础知识库/强化学习/)
