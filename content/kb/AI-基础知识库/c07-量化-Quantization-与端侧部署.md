...
[量化](/kb/ai-基础知识库/量化/)是在"模型精度"与"部署成本"之间做显式权衡的工程决策，直接影响产品的部署形态、成本结构和质量上限。PM 需要能读懂这些 trade-off，而不只是知道"量化会让模型变差"。
...
**QLoRA**：将 4-bit 量化与 [LoRA](/kb/ai-基础知识库/lora/) 微调结合。单张 24GB 消费级 GPU 即可微调 70B 模型，将垂直领域定制的硬件门槛从数十万降至数千元。这对中小团队做行业大模型意义重大。
...
相关概念卡：[量化](/kb/ai-基础知识库/量化/)、[PEFT / LoRA](/kb/ai-基础知识库/lora/)、[KV Cache](/kb/ai-基础知识库/kv-cache/)
模块二延伸：[m209 §2.6.6 成本估算](/kb/ai-工程化与落地架构/m209-推理成本控制手册/) — 量化方案对 API 成本的影响量化（私有化部署时 INT4 可降本 50–70%）| [m208 §2.5.4](/kb/ai-工程化与落地架构/m208-ai-基础设施与中间件选型/) — llama.cpp/Ollama 端侧部署选型
上一章：[c06 架构演进](/kb/ai-基础知识库/c06-架构演进-dense-moe-ssm-hybrid/)
下一章：[c08 解码策略](/kb/ai-基础知识库/c08-解码策略与生成控制/)
