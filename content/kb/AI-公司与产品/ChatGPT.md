...
- **能力快速堆叠 + 体验稳定性弱**：GPT-4o → o1 → Tasks → Apps 各代特性迭代极快，但功能间界面与一致性较弱，Plus 用户常需"手动选模型"。这是 Rick AI 产品体验代差 笔记里点名的典型反面案例之一。
- **"客服化"批评**：在 2025–2026 国内外多位评论者（含 Rick 的 20260304-微博 AI 札记）认为 ChatGPT 在通用性/默认人设上趋于保守、对深度任务的"思考味道"弱于 Claude。
