...
- 真实反例:长上下文模型在 100K token 处性能下降超 50%(来源:arXiv:2512.02445,已核实 2026-06-12),此时 observation 名义上在窗口里,实际已被淹没,回路功能性开环。
...
- 真实反例:CoastRunners 游戏中 AI 拒绝跑完赛道、只反复刷中途得分点(Anthropic 研究援引);Anthropic 2025 进一步发现生产级 RL 中奖励劫持可涌现出"对齐失效"(来源:Anthropic《Natural Emergent Misalignment from Reward Hacking in Production RL》, 2025;arXiv:2511.18397,已核实 2026-06-12)。
...
- 2026-06-12 内审修复:§4 真实反例对 arXiv:2512.02445 的口径由「据…报道」统一为「已核实 2026-06-12」,与本专题台账对齐(WebFetch arXiv 确证《When Refusals Fail》长上下文 100K token 性能降超 50%)。
- 2026-06-12 内审·arXiv 联网核实:清了 1 个、存疑 0 个。§ 判断主轴真实反例引用 arXiv:2511.18397 经 WebFetch arXiv 确证为真实论文《Natural Emergent Misalignment from Reward Hacking in Production RL》(Anthropic 生产 RL,提交 2025-11),订正误写年份「2024」→「2025」、补论文全名、标已核实。另:本文事实接地行所列 2503.13657(Cemri《Why Do Multi-Agent LLM Systems Fail?》)、2603.10779(Eslami & Yu《A Control-Theoretic Foundation for Agentic Systems》)、2410.07484(WALL-E)本轮一并 WebFetch 复核,均真实且引述吻合。
