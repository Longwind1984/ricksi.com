...
- 对照 [trip-structure skill](/kb/ai-协作方法论/trip-structure-skill/)：本节点引用它的"事件表 + 迷你导览"双层输出结构作为 structure stage 输出契约的证据，是**取证关系**，不复述其内容。
...
- 对照 [AI PM 知识图谱框架设计](/kb/ai-pm-知识图谱/ai-pm-知识图谱框架设计/)：那也是 Rick "为自己造决策工具"的设计，与 trip 套件同源；其"挂钩到具体产品判断"的结构化倾向与本节点的"接口契约化"同构，构成**互证**。

## §10 关联节点

**核心（必读）**
- [旅行规划 Skill 套件系统设计](/kb/产品/旅行规划-skill-套件系统设计/) — trip 套件设计文档，本节点的一手数据源（接口契约/状态语义出处）
- [trip-structure skill](/kb/ai-协作方法论/trip-structure-skill/) — structure stage 输出契约的取证出处
...
**延伸（可选）**
- [AI PM 知识图谱框架设计](/kb/ai-pm-知识图谱/ai-pm-知识图谱框架设计/) — 同源"为自己造决策工具"，互证
...
| [trip-structure skill](/kb/ai-协作方法论/trip-structure-skill/) | **取证**：引用其双层输出作为 structure stage 输出契约证据 |
