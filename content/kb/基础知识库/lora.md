...
详见 [c04 - 模型训练全阶段 Pipeline](/kb/基础知识库/c04-模型训练全阶段-pipeline/)。

## 相关章节与节点

- [c04 SFT 与 PEFT](/kb/基础知识库/c04-模型训练全阶段-pipeline/)
- [c07 QLoRA（4-bit 量化 + LoRA）](/kb/基础知识库/c07-量化-quantization-与端侧部署/)
- [SFT](/kb/基础知识库/sft/)（LoRA 的常见基础）
- [RLHF](/kb/基础知识库/rlhf/)（LoRA 也常用于对齐阶段，称为 LoRA-DPO）
- [RAG](/kb/基础知识库/rag/)（与 LoRA 的决策对手）
- [灾难性遗忘](/kb/基础知识库/灾难性遗忘/)（LoRA 相比全量微调的遗忘风险更低）
- [多模型分层](/kb/基础知识库/多模型分层/)（多 LoRA 部署架构的思想前置）
- [量化](/kb/基础知识库/量化/)（QLoRA 的依赖技术）
