...
## 关联节点
- [Embedding](/kb/基础知识库/embedding/) — Embedding 概念主条目
- [c02 - Tokenization 与词表工程](/kb/基础知识库/c02-tokenization-与词表工程/) — 词表大小 V 的工程决策
- [Tokenization](/kb/基础知识库/tokenization/) — 分词与 BLT 路线的对比基础
- [c03 - Transformer 核心机制与注意力变体](/kb/基础知识库/c03-transformer-核心机制与注意力变体/) — d_model 在注意力层的传播路径
- [c07 - 量化 Quantization 与端侧部署](/kb/基础知识库/c07-量化-quantization-与端侧部署/) — d 与显存预算的下游约束
