...
- [c06 架构对比](/kb/基础知识库/c06-架构演进-dense-moe-ssm-hybrid/)
- [Scaling Laws](/kb/基础知识库/scaling-laws/) — MoE 的 scaling 行为与 Dense 略不同
- [KV Cache](/kb/基础知识库/kv-cache/) — MoE 也吃 KV，与稀疏激活无关
- [多模型分层](/kb/基础知识库/多模型分层/) — 把 MoE 当一种"硬件层的专家选路"
