...
- 小语种 chunk 的 [Embedding](/kb/基础知识库/embedding/) 质量更差（语义边界混乱）
...
- **缓存（[Prompt Caching](/kb/基础知识库/prompt-caching/)）** 命中以 token 序列为单位，跨 tokenizer 不可迁移
...
详见 [拓展：无 Tokenizer 路线](/kb/基础知识库/拓展-无-tokenizer-路线/) / [拓展：多模态统一 Tokenizer 空间](/kb/基础知识库/拓展-多模态统一-tokenizer-空间/)。
...
- [c02 Tokenization 与词表工程（详解）](/kb/基础知识库/c02-tokenization-与词表工程/)
- [c03 Token 作为 Transformer 的输入](/kb/基础知识库/c03-transformer-核心机制与注意力变体/)
- [c09 Tokenization 对检索的影响](/kb/基础知识库/c09-rag-架构/)
- [c12 视觉 Tokenization](/kb/基础知识库/c12-多模态融合与具身智能/)
- [拓展：无 Tokenizer 路线](/kb/基础知识库/拓展-无-tokenizer-路线/)
- [拓展：多模态统一 Tokenizer 空间](/kb/基础知识库/拓展-多模态统一-tokenizer-空间/)
- [Embedding](/kb/基础知识库/embedding/)（token 序列 → 向量的下一步）
- [KV Cache](/kb/基础知识库/kv-cache/)（按 token 为单位缓存）
- [BPE 分词 - 离散与连续的边界辨析](/kb/基础知识库/bpe-分词-离散与连续的边界辨析/)
- [问题：为什么词表数量必须是离散有限的？](/kb/基础知识库/问题-为什么词表数量必须是离散有限的/)
