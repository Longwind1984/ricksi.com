...
- [c02 - Tokenization 与词表工程](/kb/基础知识库/c02-tokenization-与词表工程/) — 分词技术母节点。
- [Tokenization](/kb/基础知识库/tokenization/) — 概念节点。
- [Embedding](/kb/基础知识库/embedding/) — 离散到连续的跳板。
- [Softmax](/kb/基础知识库/softmax/) — 输出端硬约束的具体函数。
- [c01 - 认知重构：从确定性系统到概率系统](/kb/基础知识库/c01-认知重构-从确定性系统到概率系统/) — 全 softmax 与概率系统的连接。
