...
**2026 位置：** 仍是主导范式，但已出现"私人规则可问责化"的早期裂缝——有学术工作把 model spec / constitution 分解为可审计的原子命题（Anthropic 约 205 条、OpenAI 约 197 条），作为外部审计的治理目标（arXiv:2605.24229《How Well Do Models Follow Their Constitutions?》，Jakkli/Rajamanoharan/Nanda, 2026-05-22，ID 已核实（2026-06-12）；205/197 具体条数仍待核实）。这是私人行为宪法**向可诉公共标准转化**的第一道缝。
