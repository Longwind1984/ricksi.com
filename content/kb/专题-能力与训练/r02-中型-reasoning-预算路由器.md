...
- 真实反例：Phi-4-reasoning 平均生成 6,780 token vs 标准 Phi-4 的 378 token，准确率反而更低（69.54% vs 78.92%，来源：arXiv:2505.00127, 2025）——更长不等于更对，路由器若只盯 effort 档位不盯实际 token 消耗，会漏掉这类反噬。
