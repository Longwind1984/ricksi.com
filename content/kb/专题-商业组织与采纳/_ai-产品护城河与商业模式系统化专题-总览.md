...
- **2026-06-12 内审修复**：回填 frontmatter `see_also: ["0413","0425","0428","0430"]`（取本专题 §4/§8 跨链的四个相邻专题 `_总览`：成本工程 0413 / 信号理论 0425 / 组织采纳 0428 / 制度现象 0430）。断链复核：本专题跨专题 `_xxx系统化专题·总览` 链经全库 find 核实**均已解析**（四个 `_总览` 已归位到各自专题文件夹、文件名保留下划线前缀），无 `04NN 总览` 数字式死链；§4/§8/R02/S02 中"待归位"措辞为历史留痕,未在本轮改写（超出断链/标签/权威值/see_also 四项范围）。权威值（EU AI Act / Sycophancy / Moffatt / AgentDojo / arXiv:2604.14210）经核查本专题均未涉及错误口径,无需改。
