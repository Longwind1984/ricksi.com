...
- **正确做法**：飞轮成立需要**闭合反馈回路 + 任务特定信号**。Cursor 的"接受/拒绝代码建议"是任务特定信号（直接对齐模型优化目标），可形成真飞轮；而单纯的"代码日志堆积"不是（来源：arXiv 2510.06674《Agent-in-the-Loop: A Data Flywheel for Continuous Improvement in LLM-based Customer Support》Zhao et al., 2025，客服飞轮实验〔arXiv ID 已核实，2026-06-12〕，据该实验产线数据，任务特定信号能带来 Recall@75 +11.7%、引用准确性 +38.1% 的提升——证明飞轮的核心是反馈质量而非数据体量）。
